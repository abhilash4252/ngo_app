...
ActiveRecord::Schema.define(version: 20151126065321) do
  ...
  add_index "participations", ["user_id", "event_id"], name: "index_participations_on_user_id_and_event_id", unique: true
